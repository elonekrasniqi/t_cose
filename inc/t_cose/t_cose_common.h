...
#include <stdint.h>
#include <stdbool.h>
#include "C:\Users\ADMIN\t_cose\inc\t_cose\q_useful_buf.h" /* For t_cose_key and t_cose_sign_inputs */
...
enum t_cose_err_t {
    ...
    T_COSE_ERR_MESSAGE_FORMAT = 94,

    T_COSE_ERR_UNPROCESSED_TAG_NUMBERS = 95
